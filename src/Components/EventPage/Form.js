...
export default function Form() {
    return (
        ...
        <div className={ "bg-gradient-to-r from-[#18012E] via-[#322894] to-[#18012E]"}>
            <h1 className="text-white text-5xl  font-semibold title-font text-center">Creación de Evento</h1>
        <div className="container px-5 py-10 mx-auto flex justify-center sm:flex-nowrap flex-wrap border-px ">
