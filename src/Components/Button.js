...
export default function DropdownBtn() {
    ...
    return (
        <>
            ...
            <div id="dropdownNavbar" class={`${isActive ? 'hidden' : ''} z-10 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600`}>
